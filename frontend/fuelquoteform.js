...
app.post('/ClientPostPageSubmit', (req, res) => {
  // Handle validations
  const galsReq = req.body.fullName;
  const delAddress = req.body.address1;
  const delDate = req.body.address2;
  const suggPPG = req.body.city;
  const amountDue = req.body.state;
